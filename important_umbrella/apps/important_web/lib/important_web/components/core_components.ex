defmodule ImportantWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ImportantWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ImportantWeb.Gettext, "errors", msg, opts)
    end
  end
